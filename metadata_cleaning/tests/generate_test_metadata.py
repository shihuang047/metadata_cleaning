...
data = {'sample_name':
              ...
              'COLLECTION_DATE':
                  ['4/01/2015', '5/8/15', '03/25/2015', '03/05/2015', '06/16/2015',
                   '3/9/2015', '04/26/2015', '05/15/15', '03/09/2015', '04/26/2015',
                   '05/15/2015', '4/7/2015', '04/16/15'],
              'COLLECTION_TIME':
                  ['00:20:00', '22:00:00', '19:00:00', '11:00:00','9:45:00', '07:00:00',
              ...
              'dummiest':
                  [random.choice([0, 'Unspecified', 'not provided']) for x in range(-50, 210, 20)],
              'sex':
                  ['male']*13,
              'pregnant':
                  [random.choice([True, False]) for x in range(13)],
...
def generate_test_dataframe(
    ...
    basename : str
        ...
        "tests/test_datasets/inputs/metadata/test_<basename>.tsv"
    ...
    path = join("test_datasets", "input", "metadata", "test_%s.tsv" % basename)
    if data_pd.shape[0]:
        data_pd.to_csv(
            path,
            index=False,
